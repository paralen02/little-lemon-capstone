...
const BookingForm = (props) => {
  ...
  return (
    <header>
      <section>
      <div className="container d-flex justify-content-center align-items-center" style={{color:'black'}}>
      <div className="card p-5">
        ...
        <h1>Make your reservation today<span><img src={restaurant}/></span></h1>
      </section>
    </header>
  );
};
